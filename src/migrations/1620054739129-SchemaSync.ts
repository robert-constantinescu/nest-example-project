...
export class SchemaSync1620054739129 implements MigrationInterface {
    name = 'SchemaSync1620054739129'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_6e1de41532ad6af403d3ceb4f2" ON "event" ("type", "name") `);
